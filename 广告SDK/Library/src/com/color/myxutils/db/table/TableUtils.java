...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.color.myxutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.color.myxutils.db.table.Id>();

    /* package */
    static synchronized com.color.myxutils.db.table.Id getId(Class<?> entityType) {
        ...
        com.color.myxutils.db.table.Id id = new com.color.myxutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.color.myxutils.db.table.Id id = getId(entityType);
